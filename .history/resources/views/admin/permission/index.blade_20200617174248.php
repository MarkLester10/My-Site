  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center">
        ...
        <a href="{{route('role.create')}}" class="ml-auto btn btn-success d-flex align-items-center"><ion-icon name="add-circle-outline" class="text-lg"></ion-icon> Add Permission</a>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
