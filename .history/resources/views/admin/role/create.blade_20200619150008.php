              ...
              <div class="card-body">
                ...
                <div class="col-lg-6 mx-auto">
                  ...
                  <div class="form-group">
                    ...
                    <select name="posts_permissions[]" class="select2 select2-hidden-accessible" multiple="" data-placeholder="Select user's permissions" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true">
                      @foreach ($permissions as $permission)
                      <option value="{{ $permission->id }}">{{ $permission->name }}</option>
                      @endforeach
                    </select>
