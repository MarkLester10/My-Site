            ...
            <form role="form" action="{{route('role.store')}}" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="col-lg-6 mx-auto">
                  ...
                  <div class="form-group">
                    <label>Select Posts Permissions</label>
                    <select name="posts_permissions[]" class="select2 select2-hidden-accessible" multiple="" data-placeholder="Select permissions" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true">
