            ...
            <form role="form" action="{{route('role.store')}}" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="col-lg-6 mx-auto">
                  ...
                  <div class="form-group">
                    <label for="role_tug">Role Tug</label>
                    <input type="text" class="form-control @if($errors->has('role')) is-invalid @endif" id="role" name="role" placeholder="Role"  value="{{old('role')}}">
                    @error('role')
                    <div class="invalid-feedback">
                      {{$message}}
                    </div>
